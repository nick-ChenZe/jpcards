...
export const InlineCitationCardBody = ({
    className,
    ...props
}: InlineCitationCardBodyProps) => <HoverCardContent className={cn('relative w-80 p-0', className)} {...props} />;
...
export const InlineCitationCarouselItem = ({
    className,
    ...props
}: InlineCitationCarouselItemProps) => <CarouselItem className={cn('w-full space-y-2 p-4', className)} {...props} />;
